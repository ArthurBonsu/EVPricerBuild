...
const Button = dynamic(() => 
  import('@chakra-ui/react').then((module) => module.Button), 
  { ssr: false }
);

const Input = dynamic(() => 
  import('@chakra-ui/react').then((module) => module.Input), 
  { ssr: false }
);

const Flex = dynamic(() => 
  import('@chakra-ui/react').then((module) => module.Flex), 
  { ssr: false }
);

const Box = dynamic(() => 
  import('@chakra-ui/react').then((module) => module.Box), 
  { ssr: false }
);

const Heading = dynamic(() => 
  import('@chakra-ui/react').then((module) => module.Heading), 
  { ssr: false }
);

const VStack = dynamic(() => 
  import('@chakra-ui/react').then((module) => module.VStack), 
  { ssr: false }
);
...
const HStack = dynamic(() => 
  import('@chakra-ui/react').then((module) => module.HStack), 
  { ssr: false }
);
